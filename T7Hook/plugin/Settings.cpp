...
{
	CIniReader ini("");
	CIniReader user("t7hook_user.ini");
...
void eSettingsManager::ResetKeys()
{
	...
	iFreeCameraKeyYawPlus = VK_RIGHT_ARROW;
	iFreeCameraKeyYawMinus = VK_LEFT_ARROW;
	iFreeCameraKeyPitchPlus = VK_UP_ARROW;
	iFreeCameraKeyPitchMinus = VK_DOWN_ARROW;
